...
<body>
    ...
    <div class="row">
        <div class="column" style="background-color:#2A9D8F;"><center><h3>Aluno</h3></center></div>
        ...
        <div class="column" style="background-color:#E76F51;"><center><h3>Disciplina</h3></center></div></div>
    </div>
